...
#     diff(u1, x).subs(x, x_0) + Kd1*P - Kr1*(a1**2*x_0**2 + 2*a1*x_0*b1 + b1**2), # Kr1*u1.subs(x, x_0), # Neumann boundary condition at x_0
#     # u2.subs(x, x_L), #concentration = 0 at x_L
#     diff(u1, x).subs(x, x_L) - Kr2*(a2**2*x_L**2 + 2*a2*x_L*b2 + b2**2) # Kr2*u2.subs(x, x_L), # Neumann boundary condition at x_L
